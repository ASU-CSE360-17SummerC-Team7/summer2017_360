...
public class Team2 extends JPanel implements Observer{
   ...
   public void update(Observable o, Object arg) {
      ...
      !result.equals(((ControlCenter)o).getGPS())) {
         result = ((ControlCenter)o).getGPS();
         String[] coord = ((ControlCenter)o).getGPS().split(",");
         init(Double.parseDouble(coord[0]), Double.parseDouble(coord[1]));
      }

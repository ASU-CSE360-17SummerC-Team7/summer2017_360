...
public class Team8Weather {

    public Team8WeatherData team8WeatherData;

    public Team8Weather(Team8CityDetail city) {
        this._run(city);
    }

    private void _run(Team8CityDetail city) {
        try {
            ...
            team8WeatherData = new Team8WeatherData(summary, windSpeed, temperature, humidity, visibility, cloudCover);
        } catch (IOException | JSONException ex) {
            Logger.getLogger(Team8Weather.class.getName()).log(Level.SEVERE, null, ex);
            System.exit(1);
        }
    }

...
public class Team8Weather {
	Team8WeatherData weatherData;

	Team8Weather(Team8CityDetail city)
	{
		this._run(city);
	}
	...
	private void _run(Team8CityDetail city)
	{
		try 
		{
			...
			weatherData = new Team8WeatherData(summary, windSpeed, temperature, humidity, visibility, cloudCover); 
		} 
